...
import com.wenky.provider.framework.canal.configuration.CanalAsyncConfig;
import com.wenky.provider.framework.canal.configuration.CanalProperties;
 ...
 */
@AutoConfigureAfter({CanalAsyncConfig.class})
public class CanalClient {

    @Autowired @Lazy private CanalProperties canalProperties;
    public static final String CANAL_CLIENT_BEAN_NAME = CanalClient.class.getName();

    @Async(value = "canalAsync")
    public void listen() {
        // 创建链接
